...
# Geneva Knott
# I worked with Sierra M, Justin H and Nickolaus A.


# Add a feature capability to your script to:

# Method 1: encryptDirectoryContents()
    # os.walk -> a 3tuple with Root dir, Files(list), Directories(list)
    # for in loop -> for each file in the Files list, encrypt the data -> invoke encryptFile method

# Method 2: decryptDirectoryContents()
    # os.walk -> a 3tuple with Root dir, Files(list), Directories(list) ENCRYPTED
    # for in loop -> for each file in the Files list, encrypt the data -> invoke encryptFile method
